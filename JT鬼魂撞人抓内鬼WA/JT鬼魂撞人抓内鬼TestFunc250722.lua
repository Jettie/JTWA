...
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "ENCOUNTER_START", 846)

/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SPELL_SUMMON", nil, "Creature-0-4527-631-4225-36855-00007B7C98", "亡语者女士", "", "", "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", 71426, nil, nil, "召唤灵魂")

/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SWING_DAMAGE", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EA1", "撞魂人A1", "", "", 123)

/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SPELL_DAMAGE", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EA1", "撞魂人A1", "", "", 71544, "复仇冲击", nil, 1010)
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SPELL_DAMAGE", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EB1", "受害者人B1", "", "", 71544, "复仇冲击", nil, 1001)
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SPELL_DAMAGE", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EB2", "受害者人B2", "", "", 71544, "复仇冲击", nil, 1020)
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SPELL_DAMAGE", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EB3", "受害者人B3", "", "", 71544, "复仇冲击", nil, 1300)

/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "ENCOUNTER_END", 846, "JT测试亡语者女士", 4, 25, true)

/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SWING_MISSED", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EA1", "撞魂人A1", "", "", "PARRY")


]]
local thisWATag = "VS_HITTER"
local OnJTFakeEvent = function(event, ...)
    ...
    if waTag == thisWATag then
        ...
        if fakeEvent == "CLEU" then
            ...
            elseif subevent == "SWING_MISSED" or subevent == "SWING_DAMAGE" then
                -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SWING_MISSED", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EA1", "撞魂人A1", "", "", "PARRY")
                -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "VS_HITTER", "CLEU", time(), "SWING_DAMAGE", nil, "Creature-0-4527-631-4225-38222-00007B871F", "怨毒之影", "", "", "Player-4533-041B1EA1", "撞魂人A1", "", "", 123)
                -- SWING_DAMAGE_LANDED,Creature-0-4527-631-4225-38222-00007B871F,"怨毒之影",0x80000a48,0x80000000,Player-4533-041B1E7F,"第二个小号-维希度斯-CN",0x80000514,0x80000000,Player-4533-041B1E7F,0000000000000000,100,100,1590,3364,22762,0,0,0,17415,39629,0,-563.93,2200.78,186,1.9944,251,0,455,-1,1,0,0,160,nil,nil,nil
                if sourceGUID then                    
                    local unitType, _, _, _, _, npcId = strsplit("-", sourceGUID)
                    local numNpcId = tonumber(npcId)
                    if unitType == "Creature" and numNpcId == vengefulShadeId then
            ...
            elseif subevent == "SPELL_DAMAGE" then
                ...
                -- SPELL_DAMAGE,Creature-0-4527-631-4225-38222-00007B871F,"怨毒之影",0x80000a48,0x80000000,Player-4533-041B1E7F,"第二个小号-维希度斯-CN",0x80000514,0x80000000,71544,"复仇冲击",0x30,Player-4533-041B1E7F,0000000000000000,75,100,1590,3364,22762,0,0,0,17419,39629,0,-563.84,2200.82,186,1.9944,251,6491,23354,-1,48,4671,0,11632,nil,nil,nil,AOE
                local spellId = arg12
                local amount = arg15
                if sourceGUID and destGUID then
                    local unitType, _, _, _, _, npcId = strsplit("-", sourceGUID)
        ...
        elseif fakeEvent == "ENCOUNTER_START" then
            -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "ENCOUNTER_START", 846)
            print("ENCOUNTER_START: ", "fakeEvent=", fakeEvent)
            thisEncounterId = select(3, ...)
        ...
        elseif fakeEvent == "ENCOUNTER_END" then
            -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "ENCOUNTER_END", 846, "JT测试亡语者女士", 4, 25, true)
