...
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "SWING_MISSED", nil, "Player-4533-0582AD60", "我的普攻招架-维希度斯-CN", "", "", "Creature-0-4527-631-4225-36853-00007BA7C2", "辛达苟萨", "", "", "PARRY")
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "SPELL_MISSED", nil, "Player-4533-0582AD61", "我的技能招架-维希度斯-CN", "", "", "Creature-0-4527-631-4225-36853-00007BA7C2", "辛达苟萨", "", "", 35395, nil, nil, "PARRY")
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "ENEMY_SWING_DAMAGE", nil, "Creature-0-4527-631-4225-36853-00007BA7C2", "辛达苟萨", "", "", "Player-4533-0582AD62", "我是死人坦克-维希度斯-CN")
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "UNIT_DIED", nil, "0000000000000000", nil, nil, nil, "Player-4533-0582AD62", "我是死人坦克-维希度斯-CN")
/run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "ENCOUNTER_END", 855, "JT测试辛达苟萨", 4, 25, true)

]]
local thisWATag = "PARRY_KILLER"
local OnJTFakeEvent = function(event, ...)
    ...
    if waTag == thisWATag then
        ...
        if fakeEvent == "CLEU" then
            ...
            -- local isAPet = (UnitInRaid(shortSourceName) or UnitInParty(shortSourceName)) and false or true
            local isAPet = true
            local petOwnerName = isAPet and "X的宠物" or nil

            if subevent == "SWING_MISSED" then
                -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "SWING_MISSED", nil, "Player-4533-0582AD60", "我的普攻招架-维希度斯-CN", "", "", "Creature-0-4527-631-4225-36853-00007BA7C2", "辛达苟萨", "", "", "PARRY")
                -- SWING_MISSED,Player-4533-061AD6A3,"涂鸦天空-维希度斯-CN",0x80000514,0x80000002,Creature-0-4527-631-4225-36853-00007BA7C2,"辛达苟萨",0x80010a48,0x80000000,PARRY,nil
                if arg12 == "PARRY" then
                    print("SWING_MISSED: ", "sourceGUID=", sourceGUID, "shortSourceName=", shortSourceName, "arg12=", arg12)
                    -- 整理parryData
                    local parryData = {
                        guid = sourceGUID,
                        name = shortSourceName,
                    ...
                    updateParryCountLogs(parryData)
                    -- DevTools_Dump(parryData)
                end
            elseif subevent == "SPELL_MISSED" then
                if arg15 == "PARRY" then
                    -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "SPELL_MISSED", nil, "Player-4533-0582AD61", "我的技能招架-维希度斯-CN", "", "", "Creature-0-4527-631-4225-36853-00007BA7C2", "辛达苟萨", "", "", 35395, nil, nil, "PARRY")
                    -- SPELL_MISSED,Player-4533-061AD6A3,"涂鸦天空-维希度斯-CN",0x80000514,0x80000002,Creature-0-4527-631-4225-36853-00007BA7C2,"辛达苟萨",0x80010a48,0x80000000,49921,"暗影打击",0x1,PARRY,nil,ST
                    -- 整理parryData
                    print("SPELL_MISSED: ", "sourceGUID=", sourceGUID, "shortSourceName=", shortSourceName, "arg15=", arg15)
                    local parryData = {
                        guid = sourceGUID,
                        name = shortSourceName,
                        spell = arg12,
            ...
            elseif subevent == "ENEMY_SWING_DAMAGE" then
                -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "ENEMY_SWING_DAMAGE", nil, "Creature-0-4527-631-4225-36853-00007BA7C2", "辛达苟萨", "", "", "Player-4533-0582AD62", "我是死人坦克-维希度斯-CN")
                -- SWING_DAMAGE,Creature-0-4527-631-4225-36853-00007BA7C2,"辛达苟萨",0x80010a48,0x80000000,Player-4533-061AD6A3,"涂鸦天空-维希度斯-CN",0x80000514,0x80000002,Creature-0-4527-631-4225-36853-00007BA7C2,0000000000000000,45854623,46018500,0,0,0,0,0,-1,0,0,0,4403.33,2490.67,189,2.2126,83,16058,104298,-1,1,0,0,5461,nil,nil,nil
                -- SWING_MISSED,Creature-0-4527-631-4225-36853-00007BA7C2,"辛达苟萨",0x80010a48,0x80000000,Player-4533-061AD6A3,"涂鸦天空-维希度斯-CN",0x80000514,0x80000002,PARRY,nil
                if sourceGUID and destGUID then
                    print("ENEMY_SWING_DAMAGE: ", "sourceGUID=", sourceGUID, "destGUID=", destGUID)
                    local unitType, _, _, _, _, npcId = strsplit("-", sourceGUID)
                    local numNpcId = tonumber(npcId)
                    if unitType == "Creature" and validBossNpcIds[numNpcId] then
                        -- Boss每次攻击都存入swingTakenList中，用于检查是否为坦克
                    ...
                    -- DevTools_Dump(swingTakenList)
                end
            elseif subevent == "UNIT_DIED" then
                -- /run WeakAuras.ScanEvents("JT_FAKE_EVENT", "PARRY_KILLER", "CLEU", time(), "UNIT_DIED", nil, "0000000000000000", nil, nil, nil, "Player-4533-0582AD62", "我是死人坦克-维希度斯-CN")
                -- UNIT_DIED,0000000000000000,nil,0x80000000,0x80000000,Player-4533-0582AD60,"赛亚人的奶爸-维希度斯-CN",0x80000514,0x80000000,0
                print("UNIT_DIED: ", "destGUID=", destGUID, "shortDestName=", shortDestName)
                calculateTop5SwingTaken()
        ...
        elseif fakeEvent == "ENCOUNTER_END" then
            ...
            print("ENCOUNTER_END: ", "fakeEvent=", fakeEvent, "success=", success)
            rollReporter(success)
            isInValidEncounter = false
            C_Timer.After(3, function()
                print("delayed reportKiller")
